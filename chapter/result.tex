...
しかし、$\psi$を見ると、その絶対値は0.5に近い値を取った。%TODO:直す:psiとVの勘違い
これは、動き回る粒子が少ないことが原因である。$\psi$の定義\equref{eq:def_psi}を見ると、
...
この状態は粒子の速度だけでなく、粒子配置についても無秩序な状態であり、これらの状態では流れが生じないことが分かる。%TODO:M≒0.1について
\begin{figure}
    \centering
    \begin{tabular}{c}
...
$\omega^{-2}$に比例していることがわかる。これは一粒子状態のABPにおける速度相関のスペクトル\equref{eq:intro_ft_about_iabp}
